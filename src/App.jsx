...
function App() {
  ...
  return (
  <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white text-gray-900 dark:from-slate-900 dark:to-slate-950 dark:text-slate-100">
      <Navbar
        lang={lang}
  ...
  aria-pressed={listening || isListening}
        ...
        className={`fixed bottom-12 left-1/2 -translate-x-1/2 z-50 inline-flex h-16 w-16 items-center justify-center rounded-full border bg-gradient-to-br from-blue-50 to-white shadow-lg transition focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:from-slate-800 dark:to-slate-900 dark:border-slate-600 ${
          listening || isListening
            ? "border-blue-600 text-blue-700 dark:text-blue-300 animate-pulse"
            : "border-blue-200 text-blue-800 hover:shadow-blue-200 hover:shadow-xl dark:text-slate-100"
        }`}
